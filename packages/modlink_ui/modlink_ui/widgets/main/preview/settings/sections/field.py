...
class FieldPayloadSettingsPanel(SimpleCardWidget):
    ...
    def __init__(
        ...
        self.title_label = StrongBodyLabel("数值场设置", self)
        self.tip_label = CaptionLabel(
            "这里先只搭 field 预览的 UI，暂时不接实际渲染逻辑。",
            self,
        )
        ...
        self.settings_grid.addWidget(self.colormap_label, 0, 0)
        ...
        self.settings_grid.addWidget(self.value_range_label, 1, 0)
        self.settings_grid.addWidget(
        ...
        self.settings_grid.addWidget(self.manual_range_label, 2, 0)
        self.settings_grid.addWidget(
        ...
        self.settings_grid.addWidget(self.interpolation_label, 3, 0)
        self.settings_grid.addWidget(
        ...
        self.settings_grid.addWidget(self.transform_label, 4, 0)
        self.settings_grid.addWidget(
        ...
        self.colormap_hint_label = CaptionLabel(
            "当前先只搭 UI：染色方式、数值范围、插值方式和几何方向，后续再接实际渲染逻辑。",
            self,
        )
        self.colormap_hint_label.setWordWrap(True)
