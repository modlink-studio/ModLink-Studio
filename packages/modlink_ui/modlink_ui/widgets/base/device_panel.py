...
class StatusBadge(QLabel):
    ...
    def set_status(self, status: str) -> None:
        palette = {
            "streaming": ("采集中", "rgb(15, 94, 54)", "rgba(70, 201, 125, 0.18)"),
            "connected": ("已连接", "rgb(9, 71, 140)", "rgba(76, 156, 255, 0.16)"),
            "searching": ("搜索中", "rgb(138, 89, 0)", "rgba(255, 197, 61, 0.18)"),
            "connecting": ("连接中", "rgb(138, 89, 0)", "rgba(255, 197, 61, 0.18)"),
            "disconnecting": (
                "断开中",
                "rgb(90, 67, 15)",
                "rgba(255, 214, 102, 0.18)",
            ),
            "starting": ("启动中", "rgb(138, 89, 0)", "rgba(255, 197, 61, 0.18)"),
            "stopping": ("停止中", "rgb(90, 67, 15)", "rgba(255, 214, 102, 0.18)"),
            "disconnected": (
                "未连接",
                "rgb(92, 92, 92)",
                "rgba(0, 0, 0, 0.06)",
        ...
        text, color, background = palette.get(status, palette["disconnected"])
        self.setText(text)
        self.setStyleSheet(
            f"""
            QLabel {{
