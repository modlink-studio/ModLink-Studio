...
from modlink_ui_v2.shared.preview.views.field import FieldStreamView
from modlink_ui_v2.shared.preview.views.raster import RasterStreamView
from modlink_ui_v2.shared.preview.views.signal import SignalStreamView
...
class PreviewThemeTests(unittest.TestCase):
    ...
    def test_signal_view_applies_dark_theme_colors(self) -> None:
        with patch(
            "modlink_ui_v2.shared.preview.views.signal.isDarkTheme",
            return_value=True,
        ):
    ...
    def test_field_view_applies_dark_theme_background(self) -> None:
        with patch(
            "modlink_ui_v2.shared.preview.views.image.isDarkTheme",
            return_value=True,
        ):
    ...
    def test_raster_view_applies_dark_theme_background(self) -> None:
        with patch(
            "modlink_ui_v2.shared.preview.views.raster.isDarkTheme",
            return_value=True,
        ):
