...
class PlatformSettingsService(QObject):
    """Global settings service shared across device, acquisition, and UI layers."""
    ...
    def _resolve_path(self) -> Path:
        ...
        if not base_dir:
            return Path.home() / ".modlink-studio" / "platform_settings.json"
        return Path(base_dir) / "platform_settings.json"
